...
class CalystoHy(MetaKernel):
    ...
    banner = 'Hy('+str(language_version) +') is a wonderful dialect of Lisp that’s embeded in Python.'
    language_info = {
        'name': 'hy',
    ...
    def __init__(self, *args, **kwargs):
        ...
        module_name = '__console__'
        self.module = sys.modules.setdefault(module_name, types.ModuleType(module_name))
        self.module.__dict__.update(self.env)
        self.env = self.module.__dict__
    ...
    def do_execute_direct(self, code):
        ...
        try:
            ...
            _ast = hy_compile(tokens, self.module, root=ast.Interactive)
